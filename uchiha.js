...
global.authFile = `UchihaSession`
global.authFileJB = `UchihaJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['UchihaBot', 'Edge', '2.0.0'] : methodCodeQR ? ['UchihaBot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
